...
print(f"Number of parameter: {args.layer*2}")
...
def main():
    ...
    for exp_i in range(repeat):
        ...
        ############################################################
        make_dir(f'exp/tfim_HVA_Wiersema/N{args.num_q}/exp_{exp_i}')
        dump(data_dict, f'exp/tfim_HVA_Wiersema/N{args.num_q}/exp_{exp_i}/data_dict.pkl')
        dump(weights_dict, f'exp/tfim_HVA_Wiersema/N{args.num_q}/exp_{exp_i}/weights_dict.pkl')
